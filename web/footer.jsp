<%-- 
    Document   : footer
    Created on : Mar 15, 2024, 7:36:56 PM
    Author     : ADMIN
--%>
    ...
    <section class="py-0 pt-7 bg-1000">
        <div class="container">
            <div class="row justify-content-lg-between">
                ...
                <%int total = topCity.size();
                    int cols = (int) Math.ceil(Math.sqrt(total));
                    if(cols>6) cols = 6;
                    int rows = (int) Math.ceil((double)total/(double)cols);
                    int count = 0;
                    int emptyColumns = 0;
                    for(int i=0;i<cols;i++){
                    if(i==cols-1){emptyColumns = ((i + 1) % 6 == 0 ? 0 : 6 - ((i + 1) % 6));}
                %>
                <div class="col-6 col-md-4 col-lg-auto mb-3">
                    <ul class="list-unstyled mb-md-4 mb-lg-0">
                        <%for(int j = 0; j < rows && count < total; j++){ 
                                    City x = topCity.get(count);%>
                        <li class="lh-lg"><a class="text-200 text-decoration-none" href="#!"><%=x.getName()%></a></li>
                            <%count++;}%>
                    </ul>
                </div>
                <%}%>
                <%for (int k = 0; k < emptyColumns; k++) { %>
                <div class="col-6 col-md-4 col-lg-auto mb-3"></div>
                <% } %>
            </div>
            <hr class="text-900" />
            <div class="row">
                ...
                <div class="col-6 col-md-4 col-lg-3 col-xxl-2 mb-3"></div>
            ...
            <div class="row flex-center pb-3">
                <div class="col-md-6 order-0">
                    <p class="text-200 text-center text-md-start">All rights Reserved &copy; Nguyen Quang Anh, Spring 2024</p>
                </div>
                <div class="col-md-6 order-1">
                    <p class="text-200 text-center text-md-end"> Made with&nbsp;
                        ...
                        </svg>&nbsp;Theme by&nbsp;<a class="text-200 fw-bold" href="https://themewagon.com/" target="_blank">ThemeWagon </a>
                    </p>
                </div>
            </div>
